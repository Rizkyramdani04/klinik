...
// Fungsi untuk membuka panel sidebar
function bukaSidebar() {
    // Gantilah kelas CSS atau properti lain yang sesuai untuk menampilkan panel sidebar
    document.getElementById('sidebar').style.display = 'block';
  }

  // Fungsi untuk menutup panel sidebar
  function tutupSidebar() {
    // Gantilah kelas CSS atau properti lain yang sesuai untuk menyembunyikan panel sidebar
    document.getElementById('sidebar').style.display = 'none';
  }

  // Mengambil tombol ikon
  var tombolIkon = document.querySelector('.toggle-sidebar-btn');

  // Menambahkan event listener untuk mengendalikan pembukaan dan penutupan sidebar
  tombolIkon.addEventListener('click', function() {
...
//   tombolIkon.addEventListener('touchstart', function() {
