                ...
                <table class="table table-bordered" id="table_id">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center">
                            ...
                            <td>{{ $rekam->layanan }}</td>
                            <td>
                                <a href="{{ route('daftar.edit', $rekam->id) }}" class="btn btn-success mt-1">Pasien Lama</i></a>
                                <a href="{{ route('cetak.member', ['id' => $rekam->id, 'nama' => $rekam->nama, 'tanggal_lahir' => $rekam->tanggal_lahir]) }}" class="btn btn-warning mt-1">Cetak</i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
